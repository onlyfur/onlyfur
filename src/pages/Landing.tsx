...
const Landing: React.FC = () => {
  const features = [
    {
      icon: Crown,
      title: 'Fursuit Content',
      description: 'Share exclusive fursuit photos, videos, and transformation content with your pack.',
      gradient: 'from-orange-400 to-amber-500',
    },
    {
      icon: DollarSign,
      title: 'Multiple Revenue Streams',
      description: 'Subscriptions, tips, custom fursuit commissions, and exclusive art requests.',
      gradient: 'from-green-400 to-blue-500',
    },
    {
      icon: MessageCircle,
      title: 'Pack Communication',
      description: 'Connect with fellow furries and fans through private messages and group chats.',
      gradient: 'from-purple-400 to-pink-500',
    },
    {
      icon: Shield,
      title: 'Furry-Safe Environment',
      description: 'A judgment-free platform designed specifically for the furry community.',
      gradient: 'from-blue-400 to-purple-500',
    },
    {
      icon: TrendingUp,
      title: 'Creator Analytics',
      description: 'Track your pack growth, earnings, and engagement across species and content types.',
      gradient: 'from-pink-400 to-red-500',
    },
    {
      icon: Zap,
      title: 'Convention Integration',
      description: 'Promote your convention appearances and connect with local furry communities.',
