...
function Show-Summary {
    ...
    if ($failedTests -eq 0) {
        ...
        Write-Host ""
        Write-Host "Some tests failed. Please check the backend server and configuration." -ForegroundColor Yellow
    }
}
...
if ($backendAvailable) {
    ...
    Write-Host "Backend is not available. Skipping authentication tests." -ForegroundColor Yellow
